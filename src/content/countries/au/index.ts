...
export const auContent: CountryContent = {
  ...
  dictionary: {
    ...
    hero: {
      ...
      trustSignals: ['No credit card required', 'Import existing registers', 'Cancel anytime'],
    ...
    pricing: {
      ...
      subtitle: 'From single inspectors to organisation-wide deployments with full customisation.',
      perMonth: '/mo',
      perYear: '/yr',
      custom: 'Custom',
  ...
  home: {
    why: {
      ...
      subtitle: 'Centralise assets, automate inspections, and stay audit-ready across every site.',
      items: [
        {
      ...
      steps: [
        {
          ...
          description: 'Start free — no upfront fees or hardware required.',
        },
        { title: 'Structure setup', description: 'Configure your sites, asset types, and teams.' },
        {
          title: 'Custom forms',
          description: 'Build inspection forms that match your procedures.',
        },
        { title: 'Scale assets', description: 'Add assets individually or in bulk as you grow.' },
        {
          title: 'Track & inspect',
          description: 'Schedule, assign, and complete inspections on any device.',
        },
        {
          title: 'Import existing data',
          description: 'Bring your current registers in via CSV import.',
        },
      ],
    },
    industries: {
      ...
      items: [
        {
          title: 'Mining',
          description: 'Asset registers and inspections for demanding mine sites.',
        },
        {
          title: 'Construction',
          description: 'Keep plant and equipment compliant across projects.',
        },
        {
          title: 'Lifting Equipment',
          description: 'Manage cranes, slings, and rigging with full traceability.',
        },
        {
          title: 'Industrial Compliance',
          description: 'Standardise records and stay audit-ready.',
        },
      ],
    },
    trustBar: {
      ...
      features: [
        {
          title: 'QR Code',
          description:
            'Scan any asset to instantly pull up its register, history, and next inspection.',
        },
        {
          title: 'Offline Ready',
          description:
            "Complete inspections in the field — data syncs automatically when you're back online.",
        },
        {
          title: 'Customisation',
          description:
            'Build custom forms, fields, and workflows to match your exact compliance requirements.',
        },
        {
          title: 'Standards Compliance',
          description:
            'Built around AS/NZS, ISO, and OSHA lifting equipment standards out of the box.',
        },
        {
          title: 'Asset Management',
          description:
            'Full lifecycle tracking from acquisition to retirement across every piece of gear.',
        },
        {
          title: 'Multi Location',
          description:
            'Manage lifting gear across every site, depot, and project from a single account.',
        },
        {
          title: 'Booking',
          description:
            "Schedule and book equipment for upcoming jobs — always know what's available.",
        },
        {
          title: 'Readiness',
          description:
            "At-a-glance compliance status so you know what's cleared for use before mobilising.",
        },
        {
          title: 'Bulk Uploads',
          description:
            'Import your entire existing register from a spreadsheet in minutes — no data loss.',
        },
      ],
  ...
  auth: {
    ...
    freeTrial: {
      ...
      perks: ['No setup costs', 'Import your existing registers', 'Full access during the trial'],
